...
public final class SyncApiClient extends BaseApiClient {
    ...
    @NotThreadSafe
    public static class Builder extends BaseApiClientBuilder<Builder, com.aliyun.iotx.api.client.SyncApiClient> {

        @Override
        protected com.aliyun.iotx.api.client.SyncApiClient build(BuilderParams params) {
            return new com.aliyun.iotx.api.client.SyncApiClient(params);
        }
    }
    ...
    public static com.aliyun.iotx.api.client.SyncApiClient getInstance() {
        return getApiClassInstance(com.aliyun.iotx.api.client.SyncApiClient.class);
    }
